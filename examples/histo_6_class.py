...
the ResNet_UNet model on a 6-class segmentation
...
# Compile model - include sample_weights_mode="temporal"
...
# data sizes
train_n = len(os.listdir(os.path.join(train_dir, X_name)))
val_n = len(os.listdir(os.path.join(test_dir, X_name)))
